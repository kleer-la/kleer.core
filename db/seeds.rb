...
@trainers = []
@trainers << Trainer.create!({name: 'John Doe',country_id: 1})
@trainers << Trainer.create!({name: 'Jeff Baurer',country_id: 2})
@trainers << Trainer.create!({name: 'Michael Donovan',country_id: 3})
...
if (InfluenceZone.count == 0)
  ...
  InfluenceZone.create!( zone_name: '', tag_name: 'ZI-AMC-SV (El Salvador)', country: Country.find_by_iso_code( 'SV' ) )
